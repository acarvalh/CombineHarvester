...
def specific_syst(analysis, list_channel_opt) :
    if analysis == "HH" :
        ...
        specific_shape = {
            ...
            # ############################## Tau related:
            "CMS_ttHl_tauIDSF"              : {"correlated" : False, "renameTo" : "CMS_multilepton_eff_t_Era"      , "proc" : "MCproc"                 , "channels" :  list(set(list(list_channel_opt.keys())) - set(["4l", "3l", "2lss", "ZZCR", "WZCR"]))},
            "CMS_ttHl_tauES"                : {"correlated" : False, "renameTo" : "CMS_multilepton_scale_t_Era"     , "proc" : "MCproc"                 , "channels" : list(set(list(list_channel_opt.keys())) - set(["4l", "3l", "2lss","ZZCR","WZCR"]))},
            # ########################### FakeRate:
            ...
            "CMS_ttHl_FRjt_norm"            : {"correlated" : False, "renameTo" :"CMS_multilepton_FakeRate_jt_norm", "proc" : ["data_fakes"], "channels" : list(set(list(list_channel_opt.keys())) - set(["4l", "3l", "2lss", "ZZCR","WZCR"]))},
            "CMS_ttHl_FRjt_shape"           : {"correlated" : False, "renameTo" : "CMS_multilepton_FakeRate_jt_shape" , "proc" : ["data_fakes"], "channels" : list(set(list(list_channel_opt.keys())) - set(["4l", "3l", "2lss","ZZCR","WZCR"]))},
            "CMS_ttHl_FRet_shift"           : {"correlated" : False, "renameTo" : "CMS_multilepton_FakeRate_et_shift", "proc" : ["data_fakes"], "channels" : list(set(list(list_channel_opt.keys())) - set(["4l", "3l", "2lss","ZZCR","WZCR"]))},
            # ################# other
            "CMS_ttHl_topPtReweighting"     : {"correlated" : True, "renameTo" : "CMS_multilepton_topPtReweighting" , "proc" : ["TT"], "channels" : ["3l","WZCR"]},
            ...
            "CMS_ttHl_PS_TT_ISR"   : {"correlated" : True, "renameTo" : "CMS_multilepton_PS_TT_ISR"   , "proc" : ["TT"], "channels" : ["3l","WZCR"]},
            "CMS_ttHl_PS_TT_FSR"   : {"correlated" : True, "renameTo" : "CMS_multilepton_PS_TT_FSR"   , "proc" : ["TT"], "channels" : ["3l","WZCR"]},
