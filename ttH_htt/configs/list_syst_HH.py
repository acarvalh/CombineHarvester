...
def specific_syst(analysis, list_channel_opt) :
    if analysis == "HH" :
        ...
        specific_shape = {
            ...
            # ########################### FakeRate:
            "CMS_ttHl_FRe_shape_pt"         : {"correlated" : True, "renameTo" : "CMS_multilepton_FakeRate_e_pt"  , "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRe_shape_norm"       : {"correlated" : True, "renameTo" : "CMS_multilepton_FakeRate_e_norm", "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRe_shape_eta_barrel" : {"correlated" : True, "renameTo" : "CMS_multilepton_FakeRate_e_be"  , "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRm_shape_pt"         : {"correlated" : True, "renameTo" : "CMS_multilepton_FakeRate_m_pt"  , "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRm_shape_norm"       : {"correlated" : True, "renameTo" : "CMS_multilepton_FakeRate_m_norm", "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRm_shape_eta_barrel" : {"correlated" : True, "renameTo" : "CMS_multilepton_FakeRate_m_be"  , "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRjt_norm"            : {"correlated" : False, "renameTo" :"CMS_multilepton_FakeRate_jt_norm", "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRjt_shape"           : {"correlated" : False, "renameTo" : "CMS_multilepton_FakeRate_jt_shape" , "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            "CMS_ttHl_FRet_shift"           : {"correlated" : False, "renameTo" : "CMS_multilepton_FakeRate_et_shift", "proc" : ["data_fakes"], "channels" : list(list_channel_opt.keys())},
            # ################# other
